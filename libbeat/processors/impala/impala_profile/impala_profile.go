...
func (p *processor) run(event *beat.Event) error {
	...
	e4log := &e4_log.E4Log{
		Timestamp:   impalaProfile.Timestamp,
		Host:        impala.GetLocalIP(),
		Application: impala.Application,
		Component:   impala.ProfileComponent,
		LogLevel:    impala.ProfileLogLevel,
		ThreadName:  impala.ProfileThreadName,
		Extend:      e4_log.E4Extend{"profile_id": impalaProfile.QueryId},
		Msg:         impalaProfile.Profile,
	}
